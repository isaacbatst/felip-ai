...
1. Menção a programa real de milhas: Smiles, Latam, Azul/TudoAzul, Azul Interline/Azul Pelo Mundo/Azul Viagens, TAP, Qatar, Copa, Lufthansa, American Airlines/AA/AAdvantage, British, Turkish, Emirates, Etihad, Qantas, Aeroplan/Air Canada, Flying Blue/Air France, MileagePlus/United, Delta/Sky, Suma/Air Europa, Accor/All Accor. Programas podem ter variantes (ex.: "Smiles Liminar", "Latam Liminar", "Azul Liminar").
  ...
  E a mensagem deve conter ao menos: quantidade de milhas. Informação sobre CPF/PAX é opcional.
  ...
  NÃO é compra quando a mensagem descreve, resume ou referencia uma situação ao invés de propor uma compra diretamente. Sinais de mensagem narrativa (NÃO é compra):
  - Frases completas com sujeito + verbo + complemento descrevendo contexto
  - Referências a terceiros: "o vendedor disse", "o fornecedor informou", "a pessoa afirmou"
  - "Compro" condicional ou contextual: "se estiver alinhado, Compro", "minha resposta foi: Compro"
  - Contextualização: "falando de", "em relação a", "voltando ao assunto", "sobre aquele assunto"
  - Tom de relato/resumo: "vi anúncio", "recebi cotação", "apareceu oferta", "chegou condição"
Propostas REAIS são telegráficas: programa + quantidade + preço (CPF é opcional), sem frases explicativas.
EXTRAÇÃO
...
- Quando a mensagem não menciona CPF/PAX ou indica explicitamente ausência ("sem CPF", "não precisa de CPF", "não usa CPF", "0 CPF", "sem pax", "não precisa de pax"), cpfCount = 0.
...
Entrada: COMPRO Smiles 50k sem CPF
{"output": {"isPurchaseProposal": true, "proposals": [{"rawQuantity": "50k", "cpfCount": 0, "rawPrices": []}]}}
Entrada: Latam 100k não precisa de CPF 25
{"output": {"isPurchaseProposal": true, "proposals": [{"rawQuantity": "100k", "cpfCount": 0, "rawPrices": ["25"]}]}}
Entrada:
Compro Copa
25k
65
{"output": {"isPurchaseProposal": true, "proposals": [{"rawQuantity": "25k", "cpfCount": 0, "rawPrices": ["65"]}]}}
Entrada: COMPRO Azul 50k 19
{"output": {"isPurchaseProposal": true, "proposals": [{"rawQuantity": "50k", "cpfCount": 0, "rawPrices": ["19"]}]}}
Entrada: 30k 1 cpf comum
{"output": {"isPurchaseProposal": false}}
Entrada: 50k 2 cpf 18,50
{"output": {"isPurchaseProposal": false}}
Entrada: Voltando ao assunto SMILES,
chegou uma condição interessante de 100k.
O anunciante afirmou que consegue atender 16 CPFs.
Se estiver alinhado, Compro.
{"output": {"isPurchaseProposal": false}}
Entrada: SMILES continua sendo uma das mais comentadas.
Vi anúncio envolvendo 100k recentemente.
O vendedor disse que tem 16 lotes.
Analisei tudo e falei: Compro.
{"output": {"isPurchaseProposal": false}}
Entrada: 16 foi a quantidade informada na conversa.
A negociação está estruturada em 100k.
Tudo relacionado a SMILES.
Confirmando internamente, Compro.
{"output": {"isPurchaseProposal": false}}