...
/**
 * Redis store implementation using a shared Redis client
 * Single Responsibility: Redis operations using a shared connection
 */
@Injectable()
export class RedisStore extends RedisRepository implements OnModuleInit, OnModuleDestroy {
