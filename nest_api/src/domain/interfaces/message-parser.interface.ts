...
import type { PurchaseProposal } from '../types/purchase.types';
...
export abstract class MessageParser {
   ...
   * @param reasoningEffort Nível de raciocínio da IA ('minimal' = Rápido, 'high' = Preciso)
   * @returns Array de PurchaseProposal quando há propostas válidas, null caso contrário
   */
  abstract parse(text: string, programs?: ProgramOption[], reasoningEffort?: 'minimal' | 'high'): Promise<PurchaseProposal[] | null>;
}
