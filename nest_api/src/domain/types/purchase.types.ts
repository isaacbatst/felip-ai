...
const ProposalSchema = z.object({
  quantity: z
    ...
    .positive()
    .describe(
      'Quantidade de milhas. Sufixo k retorna milhares. Exemplos: 26.1k => 26100, 34.500k => 34500. Sufixo kk retorna milhões. Exemplos: 25kk => 25000000. Sem sufixo depende da quantidade. Exemplos: 10.400 => 10400, 12,5 => 12500.',
    ),
