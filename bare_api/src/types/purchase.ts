...
export const PurchaseRequestSchema = z.object({
	isPurchaseProposal: z
		.boolean()
		.describe("Se a mensagem é uma proposta de compra"),
	quantity: z
		.number()
		.positive()
		.nullable()
		.describe("Quantidade em milhares (ex: 27 para 27k)"),
	cpfCount: z
		.number()
		.int()
		.positive()
		.nullable()
		.describe("Número de CPFs (ex: 2 para 2CPF)"),
	airline: z
		.string()
		.nullable()
